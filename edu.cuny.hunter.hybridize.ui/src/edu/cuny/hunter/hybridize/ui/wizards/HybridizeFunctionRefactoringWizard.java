...
public class HybridizeFunctionRefactoringWizard extends RefactoringWizard {
	...
	public static void startRefactoring(Set<FunctionDefinition> functionDefinitions, IPythonNature nature, Shell shell, IProgressMonitor monitor) throws TooManyMatchesException, BadLocationException {
		Refactoring refactoring = edu.cuny.hunter.hybridize.core.utils.Util.createRefactoring(functionDefinitions, nature, monitor);
