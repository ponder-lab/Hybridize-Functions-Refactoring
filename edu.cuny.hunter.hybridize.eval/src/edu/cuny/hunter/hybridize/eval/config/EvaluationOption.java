...
public enum EvaluationOption {
	...
	ALWAYS_CHECK_TENSOR_ITERATION, PROCESS_FUNCTIONS_IN_PARALLEL, USE_TEST_ENTRYPOINTS, ALWAYS_FOLLOW_TYPE_HINTS, USE_SPECULATIVE_ANALYSIS,
	INFER_INPUT_SIGNATURES, OVERWRITE_EXISTING_INPUT_SIGNATURES, OUTPUT_CALLS, PROJECTS;
