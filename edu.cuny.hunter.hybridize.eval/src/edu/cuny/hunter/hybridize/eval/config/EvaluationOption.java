...
public enum EvaluationOption {
	...
	ALWAYS_CHECK_EAGER_ONLY_CALLS, ALWAYS_CHECK_NUMPY_CALLS, ALWAYS_CHECK_STATIC_SHAPE_READS, ALWAYS_CHECK_STALE_VARIABLE_READS,
	ALWAYS_CHECK_TENSOR_ITERATION, ALWAYS_CHECK_KERAS_SYMBOLIC_ARGUMENTS, PROCESS_FUNCTIONS_IN_PARALLEL, USE_TEST_ENTRYPOINTS,
	ALWAYS_FOLLOW_TYPE_HINTS, USE_SPECULATIVE_ANALYSIS, INFER_INPUT_SIGNATURES, OUTPUT_CALLS, PROJECTS;
